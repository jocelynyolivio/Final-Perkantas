        ...
        <form class="form">
            ...
            <div class="p1" id="p1">
                ...
                <p class="signup-link" style="color: #29351d;" id="signIn">
                    Already have an account? <a href="admin.php" style="color: #29351d;">Sign In</a>
                </p>
            </div>
    ...
    <script>
        ...
        $('#resetPass').on('click', function(e) {
            ...
            $.ajax({
                ...
                url: 'php/change_password_admin.php',
                success: function(res) {
                    console.log(res);
                    data = JSON.parse(res);
                    // console.log(data)
