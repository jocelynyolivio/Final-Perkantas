        ...
        <form class="form">
            ...
            <div class="p1" id="p1">
                ...
                <p class="signup-link" style="color: #29351d;" id="signIn">
                    Already have an account? <a href="konselor.php" style="color: #29351d;">Sign In</a>
                </p>
            </div>
    ...
    <script>
        ...
        $('#submitRst').on('click', function(e) {
            ...
            $.ajax({
                ...
                url: 'php/request_otp_konselor.php',
        ...
        $('#confirmOTP').on('click', function(e) {
            ...
            $.ajax({
                ...
                url: 'php/check_otp_konselor.php',
                success: function(res) {
                    console.log(res);
                    data = JSON.parse(res);
                    // console.log(data)
        ...
        $('#resetPass').on('click', function(e) {
            ...
            $.ajax({
                ...
                url: 'php/change_password_konselor.php',
                success: function(res) {
                    console.log(res);
                    data = JSON.parse(res);
                    // console.log(data)
