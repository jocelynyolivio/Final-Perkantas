            ...
            <div div class="container-fluid">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" style="margin-top: 0px;">
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0" style="margin-top: -5px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="page/jadwal_page.php" role="page">JADWAL</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="page/riwayat_page.php" role="page">RIWAYAT</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="page/profile_page.php" role="page">PROFIL</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="api/logout_konselor.php" role="page">LOGOUT</a>
                        </li>
                    </ul>
                </div>
            </div>
