...
$query1 = mysqli_query($con, "SELECT * FROM konselor_info WHERE konselor_email = '$teamName'");
...
if ((mysqli_num_rows($query1) === 1) && ($status == "1")) {
    ...
    $query3 = mysqli_query($con, "UPDATE `konselor_info` SET `password`='$newPass' WHERE `konselor_email` = '$teamName'");
