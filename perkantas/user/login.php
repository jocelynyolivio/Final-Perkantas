    ...
    <div class="form-container">
        <form class="form" action="" method="POST">
            ...
            <div class="p1" id="p1" style="margin-top: 30px;">
                ...
                <div class="input-container">
                    <input type="password" name="password" id="password" placeholder="Password" required><i class="fa-solid fa-eye" style="margin-left: -30px;"></i><i class="fa-solid fa-eye-slash" style="margin-left: -30px;"></i>
                </div>
                <center>
                ...
                <p class="dont">Don't Have Account? <a href="register1.php">Sign Up</a>
                </p>
