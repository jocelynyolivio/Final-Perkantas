...
<body>
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <h3 class="text-center">Form Pendaftaran Dewasa</h3>
        <br>
      </div>
    </div>
      ...
      <div class="col-12">
        <form method="post" class="form needs-validation" novalidate>
          ...
          <div class="form-outline mb-4">
            ...
            <input name="userNama" type="text" id="userNama" class="form-control form-control-lg" placeholder="Ex. John Doe" required />
          </div>

          <div class="d-md-flex justify-content-start align-items-center mb-4 py-2">
            <h6 class="mb-0 me-4">Jenis Kelamin : <span class="required text-danger">*</span></h6>
            <div class="form-check form-check-inline mb-0 me-4">
              <input class="form-check-input" type="radio" name="userKelamin" id="femaleGender" value="perempuan" required />
              <label class="form-check-label" for="femaleGender">Perempuan</label>
            </div>

            <div class="form-check form-check-inline mb-0 me-4">
              <input class="form-check-input" type="radio" name="userKelamin" id="maleGender" value="laki-laki" required />
          ...
          <div class="form-outline mb-4">
            <label class="form-label">Pekerjaan<span class="required text-danger">*</span></label>
            <input name="userPekerjaan" type="text" id="job" class="form-control form-control-lg" placeholder="Ex. Mahasiswa" required />
          </div>

          <div class="form-outline mb-4">
            <label class="form-label">Alamat<span class="required text-danger">*</span></label>
            <input name="userAlamat" type="text" id="address" class="form-control form-control-lg" placeholder="Ex. Jalan nanas nomor 2 Surabaya" required />
          </div>

          <div class="form-outline mb-4">
            <label class="form-label">Nomor HP<span class="required text-danger">*</span></label>
            <input name="userTelepon" type="text" id="phone" class="form-control form-control-lg" placeholder="08xxx" required />
            <small class="text-danger text-bold small-phone"></small>
          </div>

          <div class="form-outline mb-4">
            <label class="form-label">Pendidikan Terakhir<span class="required text-danger">*</span></label>
            <!-- <input name="userPendidikan" type="text" id="pendidikan" class="form-control form-control-lg" required /> -->
            <select name="userPendidikan" class="form-select form-select-lg" id="pendidikan" required>
          ...
          <div class="form-outline mb-4">
            ...
            <!-- <input name="userLahir" type="date" id="birth" class="form-control form-control-lg" required /> -->
            <input data-datepicker="" class="form-control form-control-lg datepicker" id="birth" name="userLahir" type="text" placeholder="HH/BB/TTTT" required>
          </div>
          ...
          <div class="row">
            <div class="col-md-6 mb-4">
              <div class="form-outline">
                ...
                <input type="number" name="userAnakKe" type="text" id="anak" class="form-control form-control-lg" placeholder="1"  min="1" required />
              </div>
            </div>
            <div class="col-md-6 mb-4">
              <div class="form-outline">
                <label class="form-label">Dari berapa bersaudara:<span class="required text-danger">*</span></label>
                <input type="number" name="userSaudara" type="text" id="saudara" class="form-control form-control-lg" placeholder="1" min="1" required />
              </div>
            </div>
          </div>
          ...
          <div class="form-outline mb-4">
            ...
            <input name="userWarganegara" type="text" id="nationality" class="form-control form-control-lg" placeholder="Ex. Indonesia" required />
          </div>

          <div class="form-outline mb-4">
            <label class="form-label">Agama<span class="required text-danger">*</span></label>
            <!-- <input name="userAgama" type="text" id="religion" class="form-control form-control-lg" required /> -->
            <select name="userAgama" class="form-select form-select-lg" id="religion" required>
          ...
          <div class="row">
            <div class="d-flex justify-content-start col-md-6 mb-4">
              <label class="form-label">Status Pernikahan : <span class="required text-danger">*</span></label>
              <select name="userStatus" class="form-select form-select-lg h-75" id="status_nikah" required>
                <option value="belum_menikah">Belum Menikah</option>
                <option value="sudah_menikah">Sudah Menikah</option>
              </select>
            </div>

            <div class="col-md-6 mb-4" id="tahun_nikah" style="visibility: hidden;">
              <div class="form-outline">
                <label class="form-label">Berapa tahun:<span class="required text-danger">*</span></label>
                <input name="userUsiaMenikah" type="text" id="tahun_nikah" class="form-control form-control-lg" />
              </div>
            </div>
          </div>

          <div class="d-flex justify-content-center pt-3">
            <button id="submit" type="button" class="btn btn-submit btn-lg ms-4">SUBMIT</button>
          </div>
        </form>
      </div>
    </div>
...
<script>
  ...
  let val = $('#status_nikah').val();
  console.log(val);
  const el = document.getElementById('status_nikah');
  const box = document.getElementById('tahun_nikah');
  el.addEventListener('change', function handleChange(event) {
    if (event.target.value === 'sudah_menikah') {
