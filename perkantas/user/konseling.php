...
$list_konseling = mysqli_query($con, "SELECT
            ...
            jk.akhir_konseling,
            ki.nama_konselor
            FROM jadwal_konseling jk LEFT JOIN konselor_info ki ON ki.konselor_email = jk.konselor_email
            WHERE user_email = '$user_email' AND tipe_service = 1");
...
<head>
    ...
    <title>Konseling Site - Griya Pulih Asih</title>
...
<body>
    ...
    <div class="col-11 col-sm-8 mx-auto mt-5">
        <h1 style="text-align:center">List Konseling</h1>
        <div class="container p-3">
            <a href="daftar_konseling.php" class="btn btn-primary px-4">+ Daftar</a>
