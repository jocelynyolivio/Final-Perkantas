<?php
include "konselor/api/connect.php";
if (isset($_SESSION['login-konselor']))
{
...
<body style="background-color: #FFCC70;">
    <div class="form-container">
        <form class="form">
            <p class="form-title">Konselor Login</p>
            <div class="p1" id="p1" style="margin-top: 30px;">
                ...
                <div class="input-container">
                    <input type="password" name="konselorPass" id="konselorPass" placeholder="Password" required><i class="fa-solid fa-eye" style="margin-left: -30px;"></i><i class="fa-solid fa-eye-slash" style="margin-left: -30px;"></i>
                </div>
                <center>
                ...
                <p class="signup-link" style="color: #29351d; margin-top: 20px;" id="signIn">
                    <a href="forgot_password_konselor.php" style="color: #29351d;">Forgot Password ?</a>
                </p>
            </div>
        </form>
    </div>
...
<script>
    ...
    $('#login').on('click', function(e) {
        ...
        $.ajax({
            type: 'POST',
            data: {konselorEmail: konselorEmail, konselorPass: konselorPass},
            url: 'konselor/api/login_konselor.php',
            success: function(res) {
                ...
                if (data['error'] == 0) {
                    Swal.fire({
                        ...
                        willClose:() => {
                            window.location.href = 'konselor/index.php';
                        }
                    });
