            ...
            <div div class="container-fluid">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" style="margin-top: 0px;">
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0" style="margin-top: -5px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="page/konselor_page.php" role="page">KONSELOR</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="page/admin_page.php" role="page">ADMIN</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="page/logs_page.php" role="page">LOGS</a>
                        </li>
                        <li class="nav-item">
